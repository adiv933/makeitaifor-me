  ...
  return (
    <div className="flex h-[100svh] w-full flex-col items-center justify-center bg-white dark:bg-black text-black dark:text-white">
      <div className="flex flex-col flex-auto justify-center items-center">
        ...
        />
        <div>
          Welcome to MakeIt<span className="text-orange-500">Ai</span>For.
        ...
        <div className="flex flex-col w-full gap-3 mt-2">
          ...
          <button
            ...
            className={
              "px-3 sm:px-4 py-1 text-lg border rounded-full hover:bg-orange-500 whitespace-nowrap font-bold m-1 text-black hover:text-white border-black dark:text-white dark:border-white hover:border-black"
            }
          >
            {"Login"}
          </button>
      ...
      <div className="py-3 text-xs">
        <a
          ...
          target="_blank"
          className="mx-3 text-gray-500 dark:text-white"
          rel="noreferrer"
        >
          Terms of use
        </a>
